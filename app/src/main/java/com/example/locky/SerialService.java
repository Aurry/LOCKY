...
//        PendingIntent restartPendingIntent = PendingIntent.getActivity(this, 1, restartIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            restartPendingIntent = PendingIntent.getActivity(this, 1, restartIntent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
        }
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//            restartPendingIntent = PendingIntent.getActivity(this,
//                    1, restartIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
//        }else {
//            restartPendingIntent = PendingIntent.getActivity(this,
//                    1, restartIntent, PendingIntent.FLAG_UPDATE_CURRENT);
//        }
